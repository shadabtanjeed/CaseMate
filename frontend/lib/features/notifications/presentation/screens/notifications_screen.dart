  ...
  Widget build(BuildContext context) {
    final notifications = [
      NotificationItem(
        ...
        message:
            'Your consultation with Dr. Sarah Johnson is scheduled for tomorrow at 10:00 AM',
        time: '2 hours ago',
        isRead: false,
      ...
      NotificationItem(
        ...
        message:
            'Your payment of \$150 for the consultation has been processed',
        time: '1 day ago',
        isRead: true,
        color: AppTheme.primaryBlue,
      ),
      ...
      NotificationItem(
        ...
        message:
            'Your consultation with Ms. Emily Rodriguez has been rescheduled to Oct 15',
        time: '3 days ago',
        isRead: true,
        color: AppTheme.primaryBlue,
      ),
  ...
  Widget _buildNotificationCard(NotificationItem notification) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color:
              notification.isRead ? AppTheme.borderColor : AppTheme.primaryBlue,
        ),
      ),
      child: Padding(
        padding: const EdgeInsets.all(16),
